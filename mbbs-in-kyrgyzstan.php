                    ...
                    <div class="pt-5 pb-5">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">MBBS in Kyrgyzstan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pb-2">
                                        ...
                                        <p class="pt-2 text-justify"><b>The most noteworthy factors attracting the Indian students get attracted due to such as </b></p>
                                        <ul>
                                            <li> MBBS in Kyrgyzstan has a lowest cost /fee structure in the world around 1.60 lacs/year</li>
                                            <li> Hostel costs are very low as compared to another country the cost is around 30000 per year </li>
                                            <li> The cost of living is around RS 6500 per month laundry as well as room cleaning </li>
                                            <li> Indian food is also the reason for the students the choose MBBS in Kyrgyzstan </i>


                                        </ul>
                                        <p class="pt-2 pb-2 text-justify"><b>Why study MBBS in Kyrgyzstan?</b></p>
                                        <ul>
                                            <li> Kyrgyzstan comes under top 3 destinations in the world to study MBBS abroad due to its main advantage of studying MBBS at lower cost. </li>
                                            <li> Studying in medical colleges of Kyrgyzstan gives a more excellent calibre of training, training regional pathology, learning diagnostics, taking care of the patients, practicing medical care, and some more.</li>
                                            <li> Every one of the nation's medical schools teaches in English Medium, and no different dialects like Russian or Kyrgyz are used during classes and in the assessments.</li>
                                            <li> There are numerous reasons why Indian students should study MBBS in Kyrgyzstan: Low Tuition fees and therefore Indian students can study medicine at a very affordable cost. Also, the cost of living in Kyrgyzstan is low. This makes Kyrgyzstan a very wise decision. </li>
                                            <li> Kyrgyzstan offers facilities which the medical universities in an affordable cost.</li>

                                        </ul>
                                        <p class="pt-2 pb-2 text-justify"> WE ARE A TOP OVERSEAS EDUCATION COUNSULTANT IN INDIA WITH MBBS. GLOW OVERSEAS EDUCATION AS BEEN SUCCESSFULLY PLACED INDIAN STUDENTS FOR ADMISSION TO MBBS IN KYRYGYSTAN. AS AN OFFICIAL REPRESENTATIVE OF MANY LOW FEE MEDICAL COLLEGE IN KYRGYSTAN IN INDIA. WE GET THE BENEFIT OF ON LINE DIRECT ADMISSION SYSTEM. THE INDIAN STUDENTS CAN DIRECTLY APPLY IN GLOW OVERSEAS EDUCATION .IT COULD GIVE INDIAN STUDENTS AN CHANCE TO GET HONEST GUIDLINE TO SELECT THE RIGHT UNIVERSITY SUITABLE FOR MBBS IN KYRGYSTAN.</p>
                                        <h5 class="pt-2 pb-2">Advantages</h5>
                                        <ul>
                                            <li> Numerous universities with WHO and Medical Council of India (MCI) and different nations associations endorsed practicing medicine anyplace they need. The degree is permitted everywhere in the world.</li>
                                            <li> Kyrgyzstan has an excellent framework, and the general climate in Kyrgyzstan is delightful.</li>
                                            <li> Traveling to Kyrgyzstan isn't troublesome as there are many non-stop flights from India to Kyrgyzstan.</li>
                                            <li> Students have an alternative to pick hostels or any apartments to live in with high-class faculty and safe living.</li>
                                            <li> Numerous colleges, pretty much every college and school, have an Indian mess, and in this way, there is no issue for any Indian student about their life of tongue.</li>
                        ...
                        <div class="b-image">
                            <div class="m-2">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="text-center"><u>About Kyrgyzstan</u></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="m-2 about">
                        ...
                        <div class="top-medical-university pt-5 pb-5">
                            <div class="row">
                                <div class="col-md-12">
                                <h5 class="pt-3 pb-3">Top Universities for MBBS in Kyrgyzstan</h5>
                                        <p class="pt-1 pb-1">Below mentioned are the top mci approved medical colleges in Kyrgyzstan-</p>
                                        <table class="table-bordered mt-3 mb-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><b>Asian Medical Institute </b></th>
                                                    <td>2004</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><b>International School of Medicine (I.S.M.)</b></th>
                                                    <td>2003</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><b>Jalal-Abad State University </b></th>
                                                    <td>1993</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><b>Osh State University</b></th>
                                                    <td>1951 </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><b>Kyrgyzstan state medical university </b></th>
                                                    <td>1939 </td>
                                                </tr>

                                            </tbody>
                                        </table>
                                        <h5 class="pt-2">MBBS in Kyrgyzstan Syllabus</h5>
                                        <p class="pb-2 text-justify">Students will cover the following Subjects while pursuing His/her Mbbs in Kyrgyzstan, theoretical and practical.</p>
                                        <table class="table-bordered mt-3 mb-3">
                                            <thead>
                                                <tr>
                                        ...
                                        <table class="table-bordered">
                                            <thead>
                                                <tr class="bg-primary text-white text-center">
                                                    ...
                                                    <th scope="col">MBBS in Kyrgyzstan</th>
                                                    <th scope="col">MBBS in India</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="text-center">Seat Availability</td>
                                                    <td class="table-info">The MBBS in Kyrgyzstan seat is not limited</td>
                                                    <td>The seats in India for pursuing MBBS are limited</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">Fees Structure</td>
                                                    <td class="table-info">MBBS In Kyrgyzstan starting tuition fees is 13.8 lakh</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-info">MBBS In Uzbekistan course duration is of 5 Years</td>
                                                    <td>MBBS In India course duration is of 5.5 years (4.5 years academics + 1-year Internship)</td>
                                                </tr>
                                        ...
                                        <h3 class="pt-2 pb-2">Average temperature of Kyrgyzstan </h3>
                                        <p class="pt-2 pb-2 text-justify"> The highest average temperature July is +28…. +31c <br />
                                            The lowest average temperature January and February -1…. -3c
                                            .</p>
                                        <h5 class="pt-2 pb-2">Religion in Kyrgyzstan</h5>
                                        <p class="pt-2 pb-2 text-justify">Kyrgyzstan in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        <p class="pt-2 pb-2 text-justify">
                                        <p class="pt-2 pb-2 text-justify">Kyrgyzstan in religious geography lies on the boundaries separating Roman Catholic, Eastern Orthodox and Islamic spheres of influence.</p>
                                        <p class="pt-2 pb-2 text-justify">There is a large number of programs that are completed within RS 10-15lacs of fees structure package. There are around 4500 Indian students studying in mci approved medical collages in Kyrgyzstan. One of the cheapest medical universities in Asia lies in Kyrgyzstan but all the universities are not advisable due to low quality of education.</p>
                                        <p class="pt-2 pb-2 text-justify">An association with GLOW OVERSEAS EDUCATION ensure the great experience of pursuing MBBS in Kyrgyzstan</p>
